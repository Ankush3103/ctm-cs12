...
mydb=mysql.connector.connect(user='root', passwd='root', host='localhost', database='')
...
def Menu():
    ...
    print(" a. Sorted as per city".center(140)) print(" b. Sorted as per district".center(140)) print(" c. Sorted as per quantity available".center(140)) print(" d. Back".center(140))
